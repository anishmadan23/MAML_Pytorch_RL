...
from metalearner_ppo2 import MetaLearnerPPO as MetaLearner
...
def main(args):
    ...
    output_name ='ppo_'+args.env_name+'_lr=' + str(args.fast_lr) + 'tau=' + str(args.tau)
    ...
    # meta_optim = optim.Adam(policy.parameters(), lr=args.meta_lr)
    ...
    for batch in range(args.num_batches):
        ...
        outer_loss = metalearner.step(episodes,args.meta_lr,eps_clip=args.eps_clip,critic_weight=args.critic_weight,entropy_wt=args.entropy_wt)
